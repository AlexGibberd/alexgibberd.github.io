"""
Draw the 28 Cromwell Road floorplan as a clean, to-scale SVG.

The geometry is built at one consistent scale from the measured room
dimensions, with the layout, fixtures and room labels set out below.
